public class Main {
    ...
    public static void main(String[] args) {
        ...
        taskManager.createTask(new Task("zad 2", "Zhopa 2", Status.NEW));

        // Создайте эпик с двумя подзадачами
        taskManager.createEpic(new Epic("epic sk 4", "ny da ny da bl     mmmmm"));
        ...
        taskManager.createEpic(new Epic("Epic", "Epiocc createsd"));
